import sys
from PyQt5.QtWidgets import QMainWindow, QAction, qApp, QApplication, QLabel, QTableView, QDialog, \
    QPushButton, \
...
def gui_create_model(database):
    ...
    list_of_columns = QStandardItemModel()
    list_of_columns.setHorizontalHeaderLabels(
    ...
    for row in list_users:
        ...
        list_of_columns.appendRow([user, ip, port, time])
...
def create_stat_model(database):
    ...
    for row in hist_list:
        ...
        list_of_columns.appendRow([user, last_seen, sent, recvd])
    return list_of_columns
